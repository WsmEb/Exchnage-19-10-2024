                                    ...
                                    <div class="table-responsive table-border table-sm ">
                                        <table class="table table-bordered   text-center">
                                            ...
                                            <tbody id='resultats'>
                                                ...
                                                @php
                                                if (session()->has('hover') && in_array($client->username, session('hover')))
                                                $bg ="bg-info";
                                                else
                                                $bg = $client->solde >= 0 ? "element-primary" : "element-secondary";
                                                @endphp

                                                <tr id="client-{{ $client->username }}">
                                                    <td class="{{$bg}} text-nowrap">{{ $client->username ?? '-' }}</td>
                                                    <td class="{{$bg}} text-nowrap">{{ $client->nom ?? '-' }}</td>
                                                    <td class="{{$bg}} text-nowrap">{{ $client->localisation ?? '-' }}</td>
                                                    <td class="{{$bg}} text-nowrap">{{ $client->commentaire ?? '-' }}</td>

                                                    <td class="{{$bg}} text-nowrap">{{ $client->solde }} {{ $entreprise->base_devise }}</td>
